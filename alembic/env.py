...
def run_migrations_offline() -> None:
    ...
    url = next(
        (
            ...
            for u in [
                os.getenv("DB__URL"),
                context.get_x_argument(as_dictionary=True).get("pz_rail_service_database_url"),
...
def run_migrations_online() -> None:
    ...
    - An `-x pz_rail_service_database_url=...` CLI argument
    ...
    # derived from env:PZ_RAIL_SERVICE_DATABASE_SCHEMA.
    target_schema = (
